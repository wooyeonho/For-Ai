...
governmentFeeDisclaimer: "신청 전 항상 공식 정부 출처를 확인하세요.",
  ...
  footer: {
    ...
    noCiteWithoutSource: "검증된 출처 없이는 인용할 수 없습니다",
    unknownNeedsVerification: "알 수 없음 = \"확인 필요\"",
  },
  common: {
    loading: "로딩 중...",
    error: "오류가 발생했습니다",
...
governmentFeeDisclaimer: "Always check the official government source before applying.",
  ...
  footer: {
    ...
    noCiteWithoutSource: "No citation without verified source",
...
governmentFeeDisclaimer: "आवेदन करने से पहले हमेशा आधिकारिक सरकारी स्रोत देखें.",
  ...
  footer: {
    ...
    suggestTopic: "विषय सुझाएँ",
    community: "समुदाय",
    forMachines: "मशीनों के लिए",
    apiDocs: "API दस्तावेज़",
    machineReadable: "मशीन-पठनीय",
    citationPolicy: "उद्धरण नीति",
    policy: "नीति",
    licenseLabel: "लाइसेंस: forai-data-license-v0.1",
    noCiteWithoutSource: "सत्यापित स्रोत के बिना उद्धरण नहीं",
    unknownNeedsVerification: "अज्ञात = \"सत्यापन आवश्यक\"",
  },
  common: {
...
governmentFeeDisclaimer: "تحقق دائمًا من المصدر الحكومي الرسمي قبل التقديم.",
  ...
  footer: {
    ...
    citationPolicy: "سياسة الاستشهاد",
    policy: "السياسة",
    licenseLabel: "الترخيص: forai-data-license-v0.1",
    noCiteWithoutSource: "لا استشهاد بدون مصدر موثّق",
    unknownNeedsVerification: "غير معروف = \"بحاجة إلى تحقق\"",
  },
  common: {
...
governmentFeeDisclaimer: "Consulta siempre la fuente oficial del gobierno antes de presentar la solicitud.",
  ...
  footer: {
    ...
    suggestTopic: "Sugerir tema",
    community: "Comunidad",
    forMachines: "Para máquinas",
    apiDocs: "Documentación API",
    machineReadable: "Legible por máquina",
    citationPolicy: "Política de citación",
    policy: "Política",
    licenseLabel: "Licencia: forai-data-license-v0.1",
    noCiteWithoutSource: "No se cita sin fuente verificada",
    unknownNeedsVerification: "Desconocido = \"Verificación pendiente\"",
  },
  common: {
    loading: "Cargando...",
...
governmentFeeDisclaimer: "申請前に必ず政府の公式情報源を確認してください。",
  ...
  footer: {
    ...
    citationPolicy: "引用ポリシー",
    policy: "ポリシー",
    licenseLabel: "ライセンス: forai-data-license-v0.1",
    noCiteWithoutSource: "検証済み出典なしでは引用不可",
    unknownNeedsVerification: "不明 =「要確認」",
  },
  common: {
    loading: "読み込み中...",
    error: "エラーが発生しました",
...
governmentFeeDisclaimer: "申请前请务必查看政府官方来源。",
  ...
  footer: {
    ...
    noCiteWithoutSource: "没有已验证来源不得引用",
    unknownNeedsVerification: "未知 =“待核实”",
  },
  common: {
    loading: "加载中...",
    error: "发生错误",
