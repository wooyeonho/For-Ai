...
const ko: UITranslations = {
  ...
  topics: {
    ...
    submitMissingFactDescription: "If a fact is missing, submit the topic without logging in. For-Ai will keep it as Needs verification until a traceable source and human review are added.",
    submitMissingFactCtaPrefix: "Submit a missing",
    submitMissingFactCtaSuffix: "fact",
    otherLanguages: "Other languages",
    oldest: "oldest",
    verificationDateNeeded: "verification date needed",
    global: "global",
  },
  country: {
    countryRegistry: "Country registry",
    description: "A static-first country dashboard for source-backed For-Ai documents. Counts are derived from the registry index; Supabase-backed rows can be included when the optional index connection is configured.",
    verifiedFacts: "Verified facts",
    needsReviewFacts: "Needs review facts",
    staleFacts: "Stale facts",
    targetFacts: "Target facts",
    questProgress: "Quest progress",
    progressSuffix: "to the current country target",
    ...
    noMissingSources: "No missing source needs detected in this country index.",
    claimCount: "claim(s)",
    ...
    verified: "verified",
    needsReview: "needs review",
    submitSourceCta: "Submit source CTA",
    knowOfficialSourcePrefix: "Know an official source for a needed",
    knowOfficialSourceSuffix: "fact?",
    submitSourceDescriptionPrefix: "Submit a source or topic for",
    submitSourceDescriptionSuffix: "Public submissions start as needs-review candidates and must be human verified before citation.",
    submitSource: "Submit a source",
  },
  bounties: {
    eyebrow: "Claim-level source bounties",
    title: "Source bounties for verifiable facts",
    description: "Bounties help contributors find source candidates for claims or topic candidates. They do not buy verification, rankings, or factual conclusions.",
    open: "open",
    sponsoredLabeled: "sponsored labeled",
    sourcesOnly: "contributors submit sources only",
    policyEyebrow: "Non-negotiable policy",
    policyTitle: "Sponsorship is separate from verification",
    tasksEyebrow: "Available tasks",
    queueTitle: "Bounty queue",
    target: "target",
  ...
  challenges: {
    ...
    lead: "Challenge progress counts accepted contributions only. Completion never means claims are automatically verified.",
    description: "Each challenge is a structured intake goal for the For-Ai fact registry. Accepted contributions can help reviewers create or update claims, but verified status still requires source-backed human approval.",
    rulesTitle: "Non-negotiable progress rules",
    ruleAcceptedOnly: "Only accepted contributions are reflected in progress.",
    ruleNotVerification: "Challenge completion is not automatic claim verification.",
  ...
  leaderboard: {
    ...
    description: "This leaderboard rewards accepted, source-backed, claim-level work. It intentionally excludes raw submission count so spam, repeated URLs, and noisy public intake cannot outrank verified contributions.",
    ...
    liveDataRequired: "Live contributor rows require the server-side Supabase service role. The public page still renders the scoring policy statically without exposing edits, reports, hallucination_reports, or raw contributor hashes.",
    ...
    criteriaTitle: "Leaderboard criteria",
    abuseEyebrow: "Abuse resistance",
    spamRulesTitle: "Spam prevention rules",
    rewardRulesTitle: "Reward rules",
    viewQuests: "View country quests and badge progress",
    actionsTitle: "Contribute source-backed facts",
    actionsDescription: "Submit missing facts without logging in. They remain Needs verification until a traceable source and human approval are recorded.",
    submitMissingFact: "Submit a missing fact",
  },
  quests: {},
  compare: {},
  aiWrongAbout: {},
