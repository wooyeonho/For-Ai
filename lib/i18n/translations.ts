...
const en: UITranslations = {
  ...
  wiki: {
    ...
    doNotCiteUnknown: "Do not cite values shown as \"Needs review\" as facts.",
  ...
  footer: {
    tagline: "A local fact registry where AI, search engines, and humans cite the same facts from the same sources. Unverified information is marked as \"Needs review\" instead of guessing.",
...
const hi: UITranslations = {
  ...
  wiki: {
    ...
    doNotCiteUnknown: "\"समीक्षा आवश्यक\" के रूप में दिखाए गए मानों को तथ्य के रूप में उद्धृत न करें।",
  ...
  footer: {
    tagline: "एक स्थानीय तथ्य रजिस्ट्री जहाँ AI, खोज इंजन और लोग समान स्रोतों से समान तथ्य उद्धृत करते हैं। असत्यापित जानकारी को अनुमान लगाने के बजाय \"समीक्षा आवश्यक\" के रूप में चिह्नित किया जाता है।",
...
const ar: UITranslations = {
  ...
  wiki: {
    ...
    doNotCiteUnknown: "لا تستشهد بالقيم المعروضة كـ \"يحتاج مراجعة\" كحقائق.",
  ...
  footer: {
    tagline: "سجل حقائق محلي حيث يستشهد الذكاء الاصطناعي ومحركات البحث والبشر بنفس الحقائق من نفس المصادر. المعلومات غير الموثقة تُعلَّم بـ \"يحتاج مراجعة\" بدلاً من التخمين.",
    forHumans: "للبشر",
...
const es: UITranslations = {
  ...
  wiki: {
    ...
    doNotCiteUnknown: "No cite valores mostrados como \"Necesita revisión\" como hechos.",
  ...
  footer: {
    tagline: "Un registro local de hechos donde la IA, los motores de búsqueda y los humanos citan los mismos hechos de las mismas fuentes. La información no verificada se marca como \"Necesita revisión\" en lugar de adivinar.",
...
const ja: UITranslations = {
  ...
  wiki: {
    ...
    doNotCiteUnknown: "\"確認必要\"と表示された値を事実として引用しないでください。",
  ...
  footer: {
    tagline: "AI・検索エンジン・人間が同じ事実を同じ根拠で引用するローカル・ファクト・レジストリ。未確認情報は推測せず\"確認必要\"として残します。",
    forHumans: "人間向け",
...
const zh: UITranslations = {
  ...
  wiki: {
    ...
    doNotCiteUnknown: "请勿将显示为\"待确认\"的值作为事实引用。",
  ...
  footer: {
    tagline: "AI、搜索引擎和人类从相同来源引用相同事实的本地事实注册表。未验证的信息标记为\"待确认\"而不是猜测。",
    forHumans: "面向用户",
