...
export interface UITranslations {
  ...
  wiki: {
    ...
    citationMixed: string;
    citationStale: string;
...
const hi: UITranslations = {
  ...
  wiki: {
    ...
    citationReady: "उद्धरण-तैयार",
    citationMixed: "मिश्रित",
    citationStale: "पुराना",
    needsVerification: "सत्यापन आवश्यक",
    fresh: "ताज़ा",
    stale: "पुराना",
    jurisdiction: "क्षेत्राधिकार",
    canCite: "उद्धृत कर सकते हैं",
    appliedRegion: "लागू क्षेत्र",
...
const ar: UITranslations = {
  ...
  wiki: {
    ...
    canCite: "يمكن الاستشهاد",
    appliedRegion: "المنطقة المطبقة",
...
const es: UITranslations = {
  ...
  wiki: {
    ...
    citationReady: "Listo para citar",
    citationMixed: "Mixto",
    citationStale: "Desactualizado",
    needsVerification: "Verificación pendiente",
    fresh: "Actualizado",
    stale: "Desactualizado",
    jurisdiction: "Jurisdicción",
    canCite: "Se puede citar",
    appliedRegion: "Región aplicada",
