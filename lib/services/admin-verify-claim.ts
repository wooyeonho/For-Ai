...
import { logAdminAuditEvent } from "@/lib/admin-api";
...
import { HIGH_RISK_CATEGORIES, isHighRiskCategory } from "@/lib/risk-policy";
...
async function maybePromoteDocument(sb: SupabaseClient, documentId: string, observedAt: string) {
...
export async function listClaimsForReviewService(sb: SupabaseClient, request: Request) {
...
export async function reviewClaimActionService(sb: SupabaseClient, request: Request, body: Record<string, unknown>) {
