...
function vClaim(
  ...
  return {
    ...
    sources: [{
      ...
      observed_at: observedAt, lang: "ko", contributor_hash: null, created_at: null,
    } as ClaimSource],
    verification_events: [{
...
const b35 = vBundle(e35, docId35, "seoul-metro-base-fare",
  ...
  vClaim("claim-metro-youth-card", docId35, e35.id, "fare.youth_card",
    "수도권 지하철 청소년(13~18세) 교통카드 기본요금은 900원입니다 (2025년 6월 28일 적용).",
    "900원 (청소년 교통카드)", "high",
    "https://www.seoulmetro.co.kr/en/page.do?menuIdx=354",
    "서울교통공사 - 운임안내",
    "청소년(만 13~18세) 기준. 2025.6.28 인상 반영."),
  vClaim("claim-metro-child-card", docId35, e35.id, "fare.child_card",
    "수도권 지하철 어린이(6~12세) 교통카드 기본요금은 550원입니다 (2025년 6월 28일 적용).",
    "550원 (어린이 교통카드)", "high",
    "https://www.seoulmetro.co.kr/en/page.do?menuIdx=354",
    "서울교통공사 - 운임안내",
    "어린이(만 6~12세) 기준. 2025.6.28 인상 반영. 만 6세 미만 무료."),
], "성인 1,550원 / 청소년 900원 / 어린이 550원 (교통카드, 2025.6.28~)");
