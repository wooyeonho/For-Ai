...
export async function HomeLanding({ locale = "en" }: { locale?: string }) {
    ...
    <div className="home">
      ...
      <section className="hero">
        ...
        <div className="hero-cta-row">
          <Link href={`${homeHref}#registry`} className="btn btn-primary">
            Browse Registry
          </Link>
      ...
      <section className="section">
        ...
        <div className="audience-grid">
          ...
          <article className="audience-card">
            ...
            <div className="audience-links">
              <Link href={`${homeHref}#registry`} className="text-link">
                Browse Registry
              </Link>
            ...
            return (
              <li key={b.document.slug} className="registry-row">
                <div className="registry-row-main">
                  <Link href={`${wikiBase}/${b.document.slug}`} className="registry-row-title">
                    {b.document.title}
                  </Link>
          ...
          <ul className="registry-index">
            {popularDocs.map((d, i) => (
              <li key={d.document_id} className="registry-row">
                <div className="registry-row-main">
                  <Link href={`${wikiBase}/${d.slug}`} className="registry-row-title">
                    {i + 1}. {d.title}
                  </Link>
                </div>
                <div className="registry-row-meta">
