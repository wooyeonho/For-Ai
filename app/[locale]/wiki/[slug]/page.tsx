    ...
    <article>
      ...
      <nav className="registry-panel" aria-labelledby="machine-links">
        ...
        <ul className="link-list">
          ...
          <li><Link href={`/${locale}/report/${document.slug}`}>{t.wiki.correctionReport}</Link></li>
          <li><Link href={`/${locale}/hallucination/${document.slug}`}>{t.wiki.hallucinationReport}</Link></li>
          <li><Link href={`/${locale}/diagnostics/${document.slug}`}>{t.wiki.diagnostics}</Link></li>
        </ul>
      </nav>
