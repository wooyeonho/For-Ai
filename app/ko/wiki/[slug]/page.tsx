    ...
    <article>
      <header className="registry-panel">
        ...
        <div className="meta-grid">
          <div>
            <span className="meta-label">entity_id</span>
            <br />
            {document.entity_id}
          </div>
          <div>
            <span className="meta-label">document_id</span>
            <br />
          ...
          <div>
            <span className="meta-label">canonical path</span>
            <br />
          ...
          <div>
            ...
            <br />
            <span className="badge badge-review">{document.status}</span>
          </div>
          <div>
      ...
      <section className="registry-panel" aria-labelledby="direct-answer">
        ...
        <p>
          <strong>{document.direct_answer}</strong>
        </p>
      </section>
      ...
      <nav className="registry-panel" aria-labelledby="machine-links">
        ...
        <ul className="link-list">
          <li>
            <Link href={document.machine_readable.api_url}>JSON API</Link>
          </li>
          <li>
            <Link href={document.machine_readable.raw_markdown_url}>
              Raw Markdown
            </Link>
          </li>
          <li>
            <Link href={`/report/${document.slug}`}>Correction report</Link>
          </li>
          <li>
            <Link href={`/hallucination/${document.slug}`}>
              AI hallucination report
            </Link>
          </li>
          <li>
            <Link href={`/diagnostics/${document.slug}`}>
      ...
      <section className="registry-panel" aria-labelledby="licensing">
        ...
        <p className="meta-label">
          license label: {document.data_license.label}
        </p>
      </section>
    </article>
  );
