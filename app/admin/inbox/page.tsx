...
const TYPE_LABELS: Record<string, string> = { community_post: "community_posts", source_suggestion: "source_candidates", hallucination_report: "hallucination_reports", report: "reports", topic_suggestion: "topic_suggestions", topic_candidate: "topic_candidates", business_correction: "business_corrections" };
