...
const commonDisallowed = ["forum", "rumor", "unsourced_blog", "unverifiable_ai_text"];
...
const domains = [
  {
    ...
    jurisdiction: "global",
    source_policy: {
      preferred: ["official", "academic", "medical_institution"],
      allowed: ["official", "academic", "medical_institution", "document", "web"],
  ...
  },
  {
    ...
    jurisdiction: "KR",
    source_policy: {
      preferred: ["official", "operator"],
      allowed: ["official", "operator", "document", "web"],
      disallowed: commonDisallowed,
    },
  ...
  },
  {
    ...
    jurisdiction: "global",
    source_policy: {
      preferred: ["manufacturer", "standard"],
      allowed: ["manufacturer", "standard", "document", "web"],
      disallowed: commonDisallowed,
    },
  ...
  },
  {
    ...
    jurisdiction: "global",
    source_policy: {
      preferred: ["academic", "museum", "official"],
      allowed: ["academic", "museum", "official", "document", "web"],
      disallowed: commonDisallowed,
    },
  ...
  },
  {
    ...
    jurisdiction: "global",
    source_policy: {
      preferred: ["standard", "manufacturer"],
      allowed: ["standard", "manufacturer", "document", "web"],
      disallowed: commonDisallowed,
    },
  ...
  },
  {
    ...
    jurisdiction: "global",
    source_policy: {
      preferred: ["standard", "manufacturer", "official"],
      allowed: ["standard", "manufacturer", "official", "document", "web"],
      disallowed: commonDisallowed,
    },
  ...
  },
  {
    ...
    jurisdiction: "global",
    source_policy: {
      preferred: ["official", "publisher"],
      allowed: ["official", "publisher", "document", "web"],
      disallowed: [...commonDisallowed, "copyrighted_long_text"],
    },
