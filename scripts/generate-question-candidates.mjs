...
const domains = [
  {
    ...
    disclaimer_type: "check_platform_source",
  ...
  },
  {
    ...
    risk_tier: "high",
    update_frequency: "realtime",
    disclaimer_type: "not_financial_or_real_estate_advice",
  ...
  {
    key: "education-deadlines",
    category: "education.deadlines",
    risk_tier: "medium",
    update_frequency: "annual",
    disclaimer_type: "check_official_source",
    source_policy_key: "official",
    subjects: ["수능 원서접수", "대학 등록금 납부", "국가장학금 신청", "검정고시 접수", "토익 시험 접수", "한국사능력검정시험 접수"],
    intents: [
      ["deadline", "기한"],
      ["fee", "수수료"],
  ...
  },
  {
    ...
    disclaimer_type: "check_official_source",
    source_policy_key: "official",
    subjects: ["최저임금", "실업급여", "육아휴직 급여", "주휴수당", "퇴직금", "연차휴가"],
    intents: [
      ["eligibility", "대상 조건"],
      ["amount", "금액 기준"],
      ["deadline", "신청 기한"],
  ...
  },
  {
    ...
    risk_tier: "high",
    update_frequency: "event_based",
    disclaimer_type: "not_legal_advice",
    source_policy_key: "regulator",
    subjects: ["청약철회", "전자상거래 환불", "중고거래 분쟁", "숙박 예약 취소", "항공권 환불", "헬스장 계약 해지"],
    intents: [
      ["period", "가능 기간"],
      ["exception", "예외 기준"],
      ["required_evidence", "필요 증빙"],
      ["complaint_channel", "신고 경로"],
    ],
  },
  {
    key: "public-profile",
    category: "public_profile.people",
    risk_tier: "medium",
    update_frequency: "annual",
    disclaimer_type: "public_profile_only",
    source_policy_key: "platform",
    subjects: ["배우 공개 프로필", "가수 공개 프로필", "운동선수 공개 프로필", "작가 공개 프로필", "감독 공개 프로필", "정치인 공개 프로필"],
    intents: [
      ["birth_year", "출생연도"],
      ["age", "나이"],
      ["official_profile", "공식 프로필"],
      ["representative_work", "대표 작품"],
    ],
  },
  {
    key: "utilities-fees",
    category: "utilities.fees",
    risk_tier: "medium",
    update_frequency: "event_based",
    disclaimer_type: "check_official_source",
    source_policy_key: "official",
    subjects: ["전기요금", "도시가스 요금", "수도요금", "종량제 봉투 가격", "공영주차장 요금", "쓰레기 대형폐기물 수수료"],
    intents: [
      ["price", "가격"],
      ["calculation", "계산 기준"],
