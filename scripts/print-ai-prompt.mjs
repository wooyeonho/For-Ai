...
const prompts = {
  "lazycodex:master": "docs/lazycodex/master-plan.txt",
  "lazycodex:p0": "docs/lazycodex/p0-stabilization.txt",
  "lazycodex:ai-readiness": "docs/lazycodex/ai-readiness.txt",
  "lazycodex:four-hour": "docs/lazycodex/four-hour-stabilization.txt",
