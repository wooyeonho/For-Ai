...
- `ai-ops/lazycodex/prompts/discovery-and-citation-review.txt` — first LazyCodex loop for Supabase-promoted document discovery and safe citation review.
...
npm run ai:prompt -- lazycodex:discovery-citation-review
